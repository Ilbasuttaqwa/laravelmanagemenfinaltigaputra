...
@section('title', 'Edit Karyawan Kandang')
...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route(auth()->user()->isAdmin() ? 'admin.karyawan-kandangs.update' : 'manager.karyawan-kandangs.update', $karyawanKandang) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                           id="nama" name="nama" value="{{ old('nama', $karyawanKandang->nama) }}" required>
                    @error('nama')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('gaji_pokok') is-invalid @enderror"
                           id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok', $karyawanKandang->gaji_pokok) }}" 
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('pembibitan_id') is-invalid @enderror"
                        ...
                        @foreach($pembibitans as $pembibitan)
                            <option value="{{ $pembibitan->id }}" {{ old('pembibitan_id', $karyawanKandang->kandang_id) == $pembibitan->kandang_id ? 'selected' : '' }}>
